# Unofficial Snap Packaging for TdhCad
This is the unofficial snap packaging for TdhCad, [Snaps are universal Linux packages](https://snapcraft.io).

Refer [snap/README.md](snap/README.md) for user-oriented information.

## Remaining Tasks
Snapcrafters ([join us](https://forum.snapcraft.io/t/join-snapcrafters/1325)) are working to land snap install documentation and the [snapcraft.yaml](https://github.com/Lin-Buo-Ren/snapcrafters-template-plus/blob/master/snap/snapcraft.yaml) upstream so TdhCad can authoritatively publish future releases.
...
- [x] Update logos and references to `TdhCad`, `tdhcad` and other placeholder names in `README.md`, `snap/README.md`, and `snap/snapcraft.yaml`
- [ ] (Skipped, just a practice)Add upstream contact information to this `README.md`
